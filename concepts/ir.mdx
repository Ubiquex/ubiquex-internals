---
title: "IR"
description: "The typed resource graph schema every SDK program ultimately compiles down to."
---
...
hand-written SDK program, or a blueprint call it makes -- it all compiles
down to the same IR before it can be resolved into a proposal. This is
what makes `ubx` a compiler in the sense the [Overview](/overview)
describes: one frontend, one typed, hashed target.
